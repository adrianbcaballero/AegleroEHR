...
resource "aws_s3_bucket" "frontend" {
  # checkov:skip=CKV_AWS_18: Frontend bundle is non-sensitive build output.
  # checkov:skip=CKV_AWS_144: Bundle is regenerable from source.
  # checkov:skip=CKV2_AWS_61: Bucket re-synced on each deploy; no lifecycle needed.
